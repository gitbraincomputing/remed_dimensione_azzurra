...
<style>
	div.mandatory {background: #FF6600}
	div.nomandatory {background: none}
	div.focused {background: #CC0000}
	div.correct {background: #66FF33}
</style>
</head>
<? require('blocchi/include_general/include_reguser.php') ?>
...
<div class="centrale">
	...
	<div class="altre_centrale">
			...
			<? require('blocchi/include_general/all_reguser.php') ?>            
