...
$(document).ready(function() {
	  ...
	  $("table").tablesorter({sortList: [[1,0]] ,widthFixed: true, widgets: ['zebra']}).tablesorterPager({container: $("#pager")}); 
});
</script>
...
<div class="titolo_pag"><h1>Anagrafica</h1></div>	
...
<?php		
			$query = "SELECT valore, etichetta
						FROM campi_combo 
						WHERE idcombo = 259 AND stato = 1 AND cancella = 'n'
						ORDER BY etichetta";
			$rs = mssql_query($query, $conn);
...
<div class="titolo_pag" style="margin-top:20px;"><h1>Residenza</h1></div>	
<div class="blocco_centralcat">
     <div class="riga">
...
<div class="titolo_pag" style="margin-top:20px;"><h1>Medico Curante</h1></div>	
<div class="blocco_centralcat">
     <div class="riga">
		<span class="rigo_mask">
            <div class="testo_mask">cognome</div>
...
<div class="titolo_pag" style="margin-top:20px;"><h1>Genitori\Tutor</h1></div>	
<div class="blocco_centralcat">
    <div class="riga">
        <div class="rigo_mask">
            <div class="testo_mask">cognome</div>
        ...
        <!-- inizio parte tab -->
			...
			<div id="container-1">
	            <ul>
	                ...
	                <li><a href="#fragment-2"><span><div onclick="javascript:reload_pagina();">Anagrafica</div></span></a></li>
	                <li><a href="#fragment-3"><span>Area Amministrativa</span></a></li>
					<? if (($tipoaccesso!=1) and ($tipoaccesso!=4)) {?>
					<li><a href="#fragment-4"><span><div>Area Sanitaria</div></span></a></li>
					<? } ?>
	            </ul>
...
<script>
	...
	$('#container-2').tabs({ remote: true }, loading_page("loading"));
	$('#container-3').tabs({ remote: true }, loading_page("loading"));
	$('#container-4').tabs({ remote: true }, loading_page("loading"));
	$('#container-5').tabs({ remote: true }, loading_page("loading"));
