...
$tablename = 'tbl_motivo_chiusura_impegnativa';
...
if (confirm('sei sicuro di voler cancellare la motivazione corrente?')){
	//document.getElementById('id_allegato').value=id;
	  $.ajax({
		   type: "POST",
		   url: "lista_motivazioni_POST.php?action=del_motivazione&id_motivazione="+id,
		   data: "",
...
function reload_motivazioni(){
	...
	pagina_da_caricare="lista_motivazioni.php";
...
<div class="titolo_pag">
		<div class="comandi">
			<div class="aggiungi aggiungi_left"><a onclick="javascript:load_content('div','lista_motivazioni.php?do=add');">aggiungi motivazione
			</a></div>
		</div>
	</div>
<?
...
if(mssql_num_rows($rs)==0){
	...
	<div class="titoloalternativo">
        <h1>Elenco Motivazioni</h1>
	</div>
	<div class="info">Non esistono motivazioni di chiusura impegnativa.</div>
...
{  		$id=$row['id'];
		...
		<tr> 
		 ...
		 <td><?=$motivazione?></td> 
		 <td><?=$descrizione?></td> 
		 <td><a id="<?=$id?>" onclick="javascript:load_content('div','lista_motivazioni.php?do=edit&id=<?=$id?>');" href="#"><img src="images/gear.png" /></a></td> 
...
<div class="logo"><img src="images/re-med-logo.png" /></div>
		...
		<div id="briciola" style="margin-bottom:20px;">
            ...
            <div class="elem_pari"><a onclick="javascript:load_content('div','lista_motivazioni.php');" href="#">elenco motivazioni</a></div>
			<div class="elem_dispari"><a href="#">aggiungi motivazioni</a></div>
          
        </div>

<form  method="post" name="form0" action="lista_motivazioni_POST.php" id="myForm">
	<input type="hidden" value="create" name="action"/>
	<input type="hidden" value="1" name="op"/>

	<div class="titolo_pag"><h1>Aggiungi Motivazioni</h1></div>
...
<div class="logo"><img src="images/re-med-logo.png" /></div>
	...
	<div id="briciola" style="margin-bottom:20px;">
		<div class="elem0"><a href="principale.php">home</a></div>
		<div class="elem_pari"><a onclick="javascript:load_content('div','lista_motivazioni.php');" href="#">elenco motivazioni</a></div>
		 <div class="elem_dispari"><a href="#">modifica motivazioni</a></div>          
	</div>
...
<form  method="post" name="form0" action="lista_motivazioni_POST.php" id="myForm">
	...
	<div class="titolo_pag"><h1>Modifica Motivaizone</h1></div>
