...
$pdf->addText(300,805,8,'Report audit modulo sanitario - '.$data_att.' - ReMed - Sanatrix Nuovo Elaion');
$pdf->line(20,40,560,40);
$pdf->addText(50,26,8,'powered by Braincomputing http://www.braincomputing.com');
$pdf->restoreState();
$pdf->closeObject();
...
$pdf->ezText("Report audit modulo\n <b>".$nome."</b>\n",18,array('justification'=>'centre'));
...
if($row1['logo']!=""){
	$pdf->addJpegFromFile('../images/'.$row1['logo'],280,$pdf->y-(-40),20,0);
...
$file="audit_mod_".$_REQUEST['idmodulo'].".txt";
