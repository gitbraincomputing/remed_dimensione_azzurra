...
$pdf->addText(300,570,8,'Report impegnative aperte al '.$data_att.' - '.$intestazione);
...
$pdf->ezText("Report impegnative aperte\n",18,array('justification'=>'centre'));
