...
$pdf->addText(300,805,8,'Istanza di un modulo del - '.$data_att.' - '.$intestazione);
...
$pdf->ezText("Stampa istanza modulo\n",18,array('justification'=>'centre'));
...
add_log($file,$_REQUEST['idpaz'],$_REQUEST['idmod'],$_REQUEST['idcart']);
