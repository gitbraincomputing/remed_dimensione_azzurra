...
function reload_review(idnormativa,data_asl){	
	...
	pagina_da_caricare="report_impegnative_attive.php?idnorm="+idnormativa+"&data_asl="+data_asl;
...
<div class="titoloalternativo">
            <h1>Elenco Pazienti: impegnative attive</h1>	        
			<?
			$web="javascript:stampa2('wrap-content');";
			$xls="ajax_report_excel.php?fun=6";
			$xml="";$doc="";
			$pdf="pdfclass/report_impegnative_attive_pdf.php";
