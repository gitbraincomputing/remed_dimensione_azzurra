...
<form  method="post" name="form0" action="lista_moduli_POST.php" enctype="multipart/form-data" id="myForm">
	...
	<div class="blocco_centralcat">
        ...
        <div class="rigo_mask">
                ...
                <div class="campo_mask mandatory controllo_file personalizzato #.doc.#">
...
while($i<$numerofield)
{
	...
	<td align="center"><input id="segnalibro<?=$i?>" name="segnalibro<?=$i?>" value="" /></td>
	<td align="center">
            ...
            <div class="riga">
             ...
             <div class="riga">
                <div class="rigo_mask">
                        ...
                        <div id="file_name" style="display:block;"><a href="view_file.php?idfile=<?=$id?>&ngid=<?=$_SESSION['UTENTE']->get_gid()?>&call=1" ><?=$word?></a></div>
...
?>	
	...
	<td align="center"><input id="segnalibro<?=$i?>" name="segnalibro<?=$i?>" value="<?=$segnalibro?>" /></td>
	<td align="center">
	<select name="editabile<?=$i?>">
...
while($i<$numerofield)
{
	...
	<td align="center">
		...
		<select id="tipo<?=$i?>" name="tipo<?=$i?>" onchange="mostra_combo(document.getElementById('tipo<?=$i?>').value);">
			<option value="1" <?if ($tipo==1) echo("selected");?>>testo</option>
			<option value="2" <?if ($tipo==2) echo("selected");?>>memo</option>
			<option value="3" <?if ($tipo==3) echo("selected");?>>data</option>
			<option value="4" <?if ($tipo==4) echo("selected");?>>combo</option>
