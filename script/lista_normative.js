<script type="text/javascript">
			...
			(
			{
			url: '../ajax_lista_normative.php',
			dataType: 'json',
			colModel : [
				{display: 'id', name : 'idnormativa', width : 50, sortable : true, align: 'center'},
				{display: 'Normativa', name : 'normativa', width : 150, sortable : true, align: 'left'},
				{display: 'Descrizione', name : 'descrizione', width : 150, sortable : true, align: 'left'}
				],
			buttons : [
...
window.location.href='lista_normative.php?do=edit&id='+elemento;
...
function funzioni_tasto(com, grid){
	 if (com=='elimina')
    ...
    else if (com=='aggiungi')
        {
			...
			window.location.href='lista_normative.php?do=add';
