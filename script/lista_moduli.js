<script type="text/javascript">
			...
			(
			{
			url: '../ajax_lista_moduli.php',
			dataType: 'json',
			colModel : [
				{display: 'id', name : 'id', width : 50, sortable : true, align: 'center'},
				{display: 'Modulo', name : 'nome', width : 150, sortable : true, align: 'left'},
...
window.location.href='lista_moduli.php?do=edit&id='+elemento;
...
function funzioni_tasto(com, grid){
	 if (com=='elimina')
    ...
    else if (com=='aggiungi')
        {
			...
			window.location.href='lista_moduli.php?do=add';
