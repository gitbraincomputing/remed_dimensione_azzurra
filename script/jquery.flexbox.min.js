...
(function($) {
    $.flexbox = function(div, o) {
        ...
        // TODO: make constructor that accepts json object instead of page source, and have it work like a combobox
        ...
        var $ctr = $(document.createElement('div'))
            ...
            .css('top', ($input.outerHeight() + 5))
            .css('left', -200)//frank mod
        ...
        function flexboxDelay(simulateArrowClick) {
            if (timeout)
                clearTimeout(timeout);
            timeout = setTimeout(function() { flexbox(1, simulateArrowClick, ''); }, o.queryDelay);
        }
            ...
            if (q.length >= o.minChars || arrowOrPagingClicked) {
                ...
                if (cached) {
                    ...
                    var callback = function(data) {
                        ...
                        totalResults = parseInt(data[o.totalProperty]);
        ...
        function showPaging(p, totalResults) {
            ...
            if (o.showResults && o.paging && totalResults > pageSize) {
                ...
                mod = totalResults % pageSize;
                if (mod > 0) pages = parseInt(++pages);
    ...
    $.fn.flexbox.defaults = {
        ...
        queryDelay: 200, // num of milliseconds before query is run.  if this is reduced, backspace on highlighted matches in input field doesn't work too well
        containerClass: 'ffb',
