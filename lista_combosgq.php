...
if (confirm('sei sicuro di voler cancellare la combo corrente?')){
	//document.getElementById('id_allegato').value=id;
	  $.ajax({
		   type: "POST",
		   url: "ajax_combo_moduli_sgq.php?id=1&id_combo="+id,
		   data: "",
		   success: function(msg){
			 ...
			 if(msg==""){
				 $.ajax({
					   type: "POST",
					   url: "lista_combosgq_POST.php?action=del_combo&id_combo="+id,
					   data: "",
					   success: function(msg){
						 //alert( "Data Saved: " + msg );
						 reload_tipologie();
...
function reload_tipologie(){
	...
	pagina_da_caricare="lista_combosgq.php";
...
<div class="logo"><img src="images/re-med-logo.png" /></div>
 ...
 <div id="briciola" style="margin-bottom:20px;">
            ...
            <div class="elem_pari"><a onclick="javascript:load_content('div','lista_combosgq.php');" href="#">elenco combo</a></div>
          
        </div>

	<div class="titolo_pag">
		<div class="comandi">
			<div class="aggiungi aggiungi_left"><a onclick="javascript:load_content('div','lista_combosgq.php?do=add');">aggiungi combo</a></div>
		</div>
	</div>
<?
...
{ 
		...
		<tr> 
		 ...
		 <td><?=$nome?></td> 
		 <td><?=$descrizione?></td> 
		 <!--<td><a onclick="prev('<?=$id?>');" href="#"><img src="images/gear.png" /></a></td>-->
        <td><a id="<?=$id?>" onclick="javascript:load_content('div','lista_combosgq.php?do=edit&id=<?=$id?>');" href="#"><img src="images/gear.png" /></a></td> 
...
<form  method="post" name="form0" action="lista_combosgq_POST.php" id="myForm">
