...
//DEFINE DI TEST 
/*
http://liveupdate.infomedica.it/caleido/ws/schemas/govit/demErogatoreTracciatoLorenzin/

AMBIENTE DI TEST:
--------------------------------------------------------------------------------------------------------------------
https://demservicetest.sanita.finanze.it/DemRicettaErogatoServicesWeb/services/demInvioErogato 
https://demservicetest.sanita.finanze.it/DemRicettaErogatoServicesWeb/services/demVisualizzaErogato 
https://demservicetest.sanita.finanze.it/DemRicettaErogatoServicesWeb/services/demSospendiErogato
https://demservicetest.sanita.finanze.it/DemRicettaErogatoServicesWeb/services/demAnnullaErogato
https://demservicetest.sanita.finanze.it/DemRicettaRicercaErogatoreServicesWeb/services/ricercaErogatore
https://demservicetest.sanita.finanze.it/DemRicettaReportServicesWeb/services/demReportErogatoMensile
https://demservicetest.sanita.finanze.it/DemRicettaServiceAnagServicesWeb/services/demServiceAnag
https://demservicetest.sanita.finanze.it/DemRicettaDifferitaServicesWeb/services/ricettaDifferita
https://demservicetest.sanita.finanze.it/DemRicettaDifferitaServicesWeb/services/annullaErogatoDiff 
https://demservicetest.sanita.finanze.it/DemRicettaServiceRicevuteWeb/services/ricevuteSac

AMBIENTE DI PRODUZIONE:
--------------------------------------------------------------------------------------------------------------------
https://demservice.sanita.finanze.it/DemRicettaErogatoServicesWeb/services/demInvioErogato 
https://demservice.sanita.finanze.it/DemRicettaErogatoServicesWeb/services/demVisualizzaErogato 
https://demservice.sanita.finanze.it/DemRicettaErogatoServicesWeb/services/demSospendiErogato
https://demservice.sanita.finanze.it/DemRicettaErogatoServicesWeb/services/demAnnullaErogato
https://demservice.sanita.finanze.it/DemRicettaRicercaErogatoreServicesWeb/services/ricercaErogatore
https://demservice.sanita.finanze.it/DemRicettaReportServicesWeb/services/demReportErogatoMensile
https://demservice.sanita.finanze.it/DemRicettaDifferitaServicesWeb/services/ricettaDifferita
https://demservice.sanita.finanze.it/DemRicettaDifferitaServicesWeb/services/annullaErogatoDiff 
https://demservice.sanita.finanze.it/DemRicettaServiceRicevuteWeb/services/ricevuteSac
...
//define("CODICE_SSA_EROGATORE", "150005");
//define("LOGIN", "URC1GXKC");                 
//define("PASSWORD", "GRAL62na");
//define("PINCODE", "1843825635");
define("PWD", "");
...
define("CA_CERT_FILE", "cert/Produzione/demservice.sanita.finanze.it_cert_2020.crt");
...
define("OP_EROG_PARZIALE", 11);
define("OP_EROG_ANNULLAMENTO", 5);
...
//DEFINE CODICI ERRORE ESITO
define("ESITO_OK", 0000);
define("ESITO_OK_SEGNALAZIONI", 0001);
...
if (isset($_REQUEST['usephp']))
{
	if ($_REQUEST['usephp']=='7')
	{
		...
		//die("$serverName - $database - $dbuser - $dbpw");
		...
		$selectTS = "SELECT top 1 login_ts,psw_ts,pincode_ts, codicestruttura_ts, codiceasl_ts,codicefiscale_ts,codiceregione_ts from struttura where idstruttura=1";
		foreach ($conn->query($selectTS) as $rowTS) {
		//print_r($rowTS);
				...
				$codicefiscale_ts=$rowTS['codicefiscale_ts'];
				$codiceregione_ts=$rowTS['codiceregione_ts'];
...
define("CODICEFISCALE",$codicefiscale_ts);
define("CODICEREGIONE",$codiceregione_ts);