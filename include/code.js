...
/*	  var http_request = false;
	  ...
	  if (window.XMLHttpRequest) { 
 			...
 			http_request = new ActiveXObject("Msxml2.XMLHTTP");
 		if (!http_request) http_request = new ActiveXObject("Microsoft.XMLHTTP");
	  }
   ...
   function makePOSTRequest(url, parameters,azione) {
   ...
   function get(id) {
	  ...
	  //alert (sid);
      var poststr ='rid=' + id;
	  makePOSTRequest('domini_ajax.php', poststr,azione);
