...
function cartella_ftp ($parametri,$dirname,$old_dirname,$action ) {
			...
			switch($action) {
				...
				case 'upload': 
					...
					//if (!file_exists($curr_path.'/'.$filename)) {
						...
						$contenuto_file .= "<?php include_once('".$percorso2."');"."\n";
						$contenuto_file .= ' show_struttura('.$idstruttura.');'."\n";
