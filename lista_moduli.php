...
function show_list()
{
	...
	$query = "SELECT * from re_distinct_moduli where tipo=$mod_type order by disuso asc, idmodulo desc";
	...
	<div id="wrap-content">
		<div class="padding10">
			...
			?>
				...
				<div class="info">Non esistono moduli.</div>
				...
				<tbody>
					...
					while ($row1 = mssql_fetch_assoc($rs1)) {
						...
						while ($row = mssql_fetch_assoc($rs)) {
							...
							$filename = $destination_path . "audit_mod_" . $idmodulo . ".txt";
							switch ($replica) {
								case "0":
									$replica = "Un/Car";
									break;
					...
					?>
							<tr>
								<td align="center"><img src="images/<?= $stato ?>" title="<?= $alt_s ?>" /></td>
								<td><?= $codice ?></td>
								<td><?= $versione ?></td>
								...
								<td><?= $replica ?></td>
								<td>
									<div id="storico_residenza" class="aggiungi "><a href="#" onclick="javascript:prev('<?= $id ?>');" title="anteprima modulo"><img src="images/view.png" /></a></div>
								</td>
								<td><a id="<?= $id ?>" href="stampa_modulo.php?idmoduloversione=<?= $id ?>" title="elenco segnalibri"><img src="images/book_open.png" /></a></td>
								<td>
									<? if (file_exists($filename)) { ?>
										<a id="<?= $id ?>" href="pdfclass/stampa_audit.php?idmodulo=<?= $idmodulo ?>&nome=<?= $nome ?>" title="report audit" target="_blank"><img src="images/book_open.png" /></a>
									<? } else { ?>
										&nbsp;
									<? } ?>
								</td>
								<td><a id="<?= $id ?>" onclick="javascript:load_content('div','lista_moduli.php?do=edit&id=<?= $id ?>');" href="#" title="modifica modulo"><img src="images/gear.png" /></a></td>
								<td><a id="<?= $id ?>" onclick="javascript:load_content('div','lista_moduli.php?do=edit_vers&id=<?= $id ?>');" href="#" title="modifica modulo"><img src="images/gear.png" /></a></td>
...
?>
	...
	<div id="wrap-content">
		<div class="padding10">
			...
			<form method="post" name="form0" action="lista_moduli_POST.php" enctype="multipart/form-data" id="myForm">
				...
				<div class="blocco_centralcat">
					...
					<div class="riga">
						<div class="rigo_mask">
							<div class="testo_mask">
								<span class="need">codice sgq</span>
							</div>
						...
						<div class="rigo_mask">
							...
							<div class="campo_mask ">
								<select name="replica">
									<option value="0" selected>unico per cartella</option>
									<option value="1">multiplo per cartella</option>
									<option value="2">unico per impegnativa</option>
									<option value="3">multiplo per impegnativa</option>
								</select>
							</div>
						</div>
						<div class="rigo_mask">
					...
					<div class="riga">
						...
						<div class="rigo_mask">
							<div class="testo_mask">Modifica multiutente</div>
							<div class="campo_mask">
								<input type="checkbox" class="h_small" name="edit_all">
							</div>
						</div>
					</div>
					<div class="riga">
						<div class="rigo_mask">
							<div class="testo_mask">Secondo allegato previsto</div>
							<div class="campo_mask">
								<input type="checkbox" class="h_small" name="secondo_allegato">
							</div>
						</div>
						<div class="rigo_mask">
							<div class="testo_mask">Terzo allegato previsto</div>
							<div class="campo_mask">
								<input type="checkbox" class="h_small" name="terzo_allegato">
							</div>
						</div>
						<div class="rigo_mask">
							<div class="testo_mask">Quarto allegato previsto</div>
							<div class="campo_mask">
								<input type="checkbox" class="h_small" name="quarto_allegato">
							</div>
						</div>
					</div>
					<div class="riga">
						<div class="rigo_mask">
							<div class="testo_mask">Documento da firmare digitalmente</div>
							<div class="campo_mask">
								<input type="checkbox" class="h_small" name="firma_digitale">
							</div>
						</div>
						<div class="rigo_mask">
							<div class="testo_mask">Documento da firmare grafometricamente</div>
							<div class="campo_mask">
								<input type="checkbox" class="h_small" name="firma_fea">
							</div>
						</div>
					</div>
					<div class="riga">
					...
					<div class="riga">
						<div class="rigo_mask">
							...
							<div class="campo_mask nomandatory controllo_file personalizzato">
    ...
    $("#elenco").tableDnD();
					...
					<table id="elenco" style="clear:both" cellspacing="2" cellpadding="2" border="0">
						...
						<tbody id="tbody">
							...
							<tr id="1000" class="riga_sottolineata_diversa nodrag nodrop">
								<td align="center"><span><a OnClick="javascript:DinamicDiv('0','add','<?= $numerofield ?>');"><img src="images/add.png" /></a></td>
							</tr>
						</tbody>
					</table>
...
function edit($id)
{
	...
	if ($row = mssql_fetch_assoc($rs)) {
		...
		$edit_all = trim($row['edit_all']);
		$secondo_allegato = trim($row['secondo_allegato']);
		$terzo_allegato = $row['terzo_allegato'];
		$quarto_allegato = $row['quarto_allegato'];
		$firma_digitale = trim($row['firma_digitale']);
	...
	<div id="wrap-content">
		<div class="padding10">
			...
			<form method="post" name="form0" action="lista_moduli_POST.php">
				...
				<input type="hidden" name="crea_versione" value="0" />
				...
				<div class="blocco_centralcat">
					...
					<div class="riga">
						...
						<div class="rigo_mask">
							<div class="testo_mask">Modifica multiutente</div>
							<div class="campo_mask">
								<input type="checkbox" <?php if ($edit_all == 1) echo 'checked'; ?> class="h_small" name="edit_all">
							</div>
						</div>
					</div>
					<div class="riga">
						<div class="rigo_mask">
							<div class="testo_mask">Secondo allegato previsto</div>
							<div class="campo_mask">
								<input type="checkbox" <?php if ($secondo_allegato == 1) echo 'checked'; ?> class="h_small" name="secondo_allegato">
							</div>
						</div>
						<div class="rigo_mask">
							<div class="testo_mask">Terzo allegato previsto</div>
							<div class="campo_mask">
								<input type="checkbox" <?php if ($terzo_allegato == 1) echo 'checked'; ?> class="h_small" name="terzo_allegato">
							</div>
						</div>
						<div class="rigo_mask">
							<div class="testo_mask">Quarto allegato previsto</div>
							<div class="campo_mask">
								<input type="checkbox" <?php if ($quarto_allegato == 1) echo 'checked'; ?> class="h_small" name="quarto_allegato">
							</div>
						</div>
					</div>
					<div class="riga">
						<div class="rigo_mask">
							<div class="testo_mask">Documento da firmare digitalmente</div>
							<div class="campo_mask">
								<input type="checkbox" <?php if ($firma_digitale == 1) echo 'checked'; ?> class="h_small" name="firma_digitale">
							</div>
						</div>
						<div class="rigo_mask">
							<div class="testo_mask">Documento da firmare grafometricamente</div>
							<div class="campo_mask">
								<input type="checkbox" <?php if ($firma_fea == 1) echo 'checked'; ?> class="h_small" name="firma_fea">
							</div>
						</div>
					</div>
					<div class="riga">
					...
					<div class="riga">
						...
						<div class="rigo_mask">
							...
							<div id="file_box" class="campo_mask nomandatory controllo_file ,cambia_mod,si#" style="display:none">
								<input type="file" name="word" id="word" />
							</div>
						</div>
    ...
    $("#elenco").tableDnD();
						...
						<table style="clear:both;" id="elenco" cellspacing="2" cellpadding="2" border="0">
							<tbody id="tbody">
								...
								<tr id="1000" class="riga_sottolineata_diversa nodrag nodrop">
									<td align="center"><span class="id_notizia_cat"><a OnClick="javascript:DinamicDiv('0','add','<?= $numerofield ?>');" class="puntatore"><img src="images/add.png" /></a></td>
								</tr>
							</tbody>
						</table>
	...
	<div id="wrap-content">
		<div class="padding10">
			...
			<form method="post" name="form0" action="lista_moduli_POST.php">
				<input type="hidden" name="action" value="update" />
				<input type="hidden" name="id" value="<?= $id ?>" />
				<input type="hidden" name="crea_versione" value="1" />
				<input type="hidden" name="cambia_mod" value="no" id="cambia_mod" />
				<input type="hidden" name="nome_mod" value="<?= $word ?>" />
				...
				<div class="blocco_centralcat">
					...
					<div class="riga">
						...
						<div class="rigo_mask">
							<div class="testo_mask">replica</div>
							<div class="campo_mask ">
								<select name="replica" onFocus="body.focus();this.blur();">
									<option value="0" <? if ($replica == 0) echo ("selected") ?>>unico per cartella</option>
									<option value="1" <? if ($replica == 1) echo ("selected") ?>>multiplo per cartella</option>
									<option value="2" <? if ($replica == 2) echo ("selected") ?>>unico per impegnativa</option>
									<option value="3" <? if ($replica == 3) echo ("selected") ?>>multiplo per impegnativa</option>
						...
						<div class="rigo_mask">
							<div class="testo_mask">modulo in disuso</div>
							<div class="campo_mask mandatory">
								<select name="disuso" onFocus="body.focus();this.blur();">
									<option value="1" <? if ($disuso == 1) echo ("selected") ?>>Si</option>
									<option value="0" <? if ($disuso == 0) echo ("selected") ?>>No</option>
								</select>
							</div>
								...
								?>
									...
									<tr id="<?= $i ?>" class="<?= $class ?>">
										...
										<td align="center">
											...
											<select id="tipo<?= $i ?>" name="tipo<?= $i ?>" onchange="mostra_combo(document.getElementById('tipo<?= $i ?>').value,<?= $i ?>);" onFocus="body.focus();this.blur();">
												<option value="1" <? if ($tipo == 1) echo ("selected"); ?>>testo</option>
												<option value="2" <? if ($tipo == 2) echo ("selected"); ?>>memo</option>
												<option value="3" <? if ($tipo == 3) echo ("selected"); ?>>data</option>
												<option value="4" <? if ($tipo == 4) echo ("selected"); ?>>combo</option>
											...
											if ($row_1 = mssql_fetch_assoc($rs_1)) { ?>
												...
												<? $idcombo = $row_1['idcombo'];
													...
													<select id="tipo_combo<?= $i ?>" name="tipo_combo<?= $i ?>" onFocus="body.focus();this.blur();">
														<? $conn = db_connect();
														print('<option value="">Selezionare una combo</option>' . "\n");
														$query = "SELECT id, nome, stato, cancella FROM dbo.combo WHERE (stato = 1) AND (cancella = 'n')  and (tipo=$mod_type)";
														$rs1 = mssql_query($query, $conn);
													...
													if ($row_1 = mssql_fetch_assoc($rs_1)) { ?>
														...
														<? $idcombo = $row_1['idcombo'];
															...
															<select id="tipo_combo_ram<?= $i ?>" name="tipo_combo_ram<?= $i ?>" onFocus="body.focus();this.blur();">
																<? $conn = db_connect();
																print('<option value="">Selezionare una combo ramificata padre</option>' . "\n");
																$query = "SELECT id, nome, stato, cancella FROM dbo.combo_ramificate WHERE (stato = 1) AND (cancella = 'n')  and (tipo=$mod_type) and (idcombopadre is null or idcombopadre=0)";
																$rs1 = mssql_query($query, $conn);
	...
	if (in_array($id_permesso, $_SESSION['PERMESSI'])) {
		...
		switch ($do) {
			...
			case "edit_vers":
				...
				if (!$_SESSION['UTENTE']->controlla_permessi($id_permesso, 2))
					error_message("Permessi insufficienti per questa operazione!");
				else edit_versione($_REQUEST['id']);
				break;
