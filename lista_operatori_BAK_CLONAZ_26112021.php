...
function edit($id)
{
	$idoperatore=$id;
	$conn = db_connect();
	$query = "SELECT dbo.operatori.privacy_cartella, dbo.operatori.med_resp, dbo.operatori.titolo, dbo.operatori.bk_code, dbo.operatori.usa_firma, dbo.operatori.key_firma, dbo.operatori.check_pass,dbo.operatori.check_pass_60, dbo.operatori.case_manager, dbo.operatori.uid,dbo.operatori.gestore_cartella as gest_cart, dbo.operatori.gid, dbo.operatori.nome, dbo.operatori.status, 
	dbo.operatori.cancella, dbo.gruppi.nome AS gr_nome, dbo.gruppi.tipo AS gr_tipo, dbo.operatori.descr, dbo.operatori.username, 
	dbo.operatori.password, dbo.operatori.email, dbo.operatori.is_root, dbo.operatori.dir_sanitario, dbo.operatori.dir_tecnico 
