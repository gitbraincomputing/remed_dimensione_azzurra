					 ...
					 function(i,row) 
					 	{
							...
							tr.className = 'riga';
							if (i % 2 && p.striped) tr.className = 'riga erow';
					...
					(
						function ()
							...
							.dblclick(
								...
								{
									var obj = (e.target || e.srcElement); if (obj.href || obj.type) return true;
									doppioclick($(this)[0].id.substring(3));
								}
							) 
							.mousedown(
								function (e)
		...
		if (p.searchitems)
			{
				...
				$(g.sDiv).append("<div class='sDiv2'>ricerca <input type='text' size='30' name='q' class='qsbox' /><select name='qtype'>"+sopt+"</select> <input type='button' value='Clear' /></div>");

				$('input[name=q],select[name=qtype]',g.sDiv).keydown(function(e){if(e.keyCode==13) g.doSearch()});
				//$('input[name=q],select[name=qtype]',g.sDiv).keydown(function(e){g.doSearch()}); 
