...
<div class="titolo_pag">
		<div class="comandi">
			<div class="aggiungi aggiungi_left"><a onclick="javascript:load_content('div','lista_configurazione.php?do=add');">aggiungi configurazione</a></div>
		</div>
	</div>
<?
$query = "SELECT * from configurazione_sistema order by variabile asc";	
...
if($conta==0){
	...
	<div class="titoloalternativo">
        <h1>Elenco Configurazioni</h1>
	</div>
	<div class="info">Non esistono configurazioni.</div>
...
{   
		...
		$id=$row['idconf'];
		$variabile=pulisci_lettura($row['variabile']);
		$valore=pulisci_lettura($row['valore']);
		$stato=$row['stato'];
		...
		<tr> 
		 ...
		 <td><a id="<?=$id?>" onclick="javascript:load_content('div','lista_configurazione.php?do=edit&id=<?=$id?>');" href="#"><img src="images/gear.png" /></a></td> 
...
<form  method="post" name="form0" action="lista_configurazione_POST.php" id="myForm">
	<input type="hidden" value="create" name="action"/>
	<input type="hidden" value="1" name="op"/>

	<div class="titolo_pag"><h1>Aggiungi Configurazione</h1></div>

	<div class="blocco_centralcat">

	<div class="riga">
	    <div class="rigo_mask">
			<div class="testo_mask">Variabile</div>
			<div class="campo_mask mandatory">
				<input type="text" name="variabile" class="scrittura" size="50"/>
			</div>
		</div>
...
<div class="riga">
	    <div class="rigo_mask">
			<div class="testo_mask">Valore</div>
			<div class="campo_mask mandatory">
				<input type="text" name="valore" class="scrittura" size="50"/>
			</div>
		</div>
    </div>    
...
<form  method="post" name="form0" action="lista_normative_POST.php" id="myForm">
	...
	<div class="titolo_pag"><h1>Modifica Normativa</h1></div>
