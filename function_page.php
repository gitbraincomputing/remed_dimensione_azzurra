	...
	function addToParentList(cont,nome_medico,id_medico,tipo) {				
		if(tipo=='mod'){
			...
			$("#medico_id_"+cont).val(id_medico);
					...
					// "id_medico" = prima data scadenza ciclica, "nome_medico" successive date e scadenze, tutto calcolato in get_genera_date_pianificate.php
			$("#scadenza_cicl_elenco_date"+cont).val(id_medico + "|" + nome_medico.toString());
		}else{
